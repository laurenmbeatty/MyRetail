...
- `npm run deploy` - Runs the build script and deploys to surge. Application is currently running at [http://my-retail.surge.sh/](http://my-retail.surge.sh/). Ship it! 🛳️
  `
